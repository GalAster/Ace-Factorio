data:extend({
  ...
  {	type = "item",
	...
	icon = "__AceSpace__/graphics/assembling-machine/icon.png",
	flags = {"goes-to-quickbar"},
	subgroup = "station-construction",
  ...
  {	type = "assembling-machine",
	...
	animation =
	{
	  filename = "__AceSpace__/graphics/assembling-machine/assembling-machine.png",
	  priority = "high",
	  width = 113,
	  height = 99,
	  frame_count = 32,
