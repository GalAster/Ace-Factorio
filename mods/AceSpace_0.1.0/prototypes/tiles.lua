data:extend({
  {	type = "tile",
	...
	variants = {
		main = {
		  {	picture = "__AceSpace__/graphics/terrain/space1.png",
			count = 16,
			size = 1
			},
		  {	picture = "__AceSpace__/graphics/terrain/space2.png",
			count = 4,
			size = 2,
			probability = 0.39,
			},
		  {	picture = "__AceSpace__/graphics/terrain/space4.png",
			count = 4,
			size = 4,
			probability = 1,
			},
